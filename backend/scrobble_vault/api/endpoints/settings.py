...
SERVICE = "scrobble_vault"
SPEC_PATH = Path(__file__).resolve().parent.parent.parent / "settings_spec.json"
...
async def patch_settings(updates: dict):
    ...
    # Nothing to restart, the sync loop and the llm endpoint gate both re-read env
    return _payload()
